...
return url : http://wordpress-path/wp-content/plugins/woo-pulzepay/payment-result.php
*/
...
if ($the_status == 200) {
    ...
    $order->add_order_note('PulzePay Payment Status: SUCCESSFUL' . '<br>Transaction ID: ' . $_POST['trans_id'] .'<br>Reference Code: '. $_POST['ref_code']);
